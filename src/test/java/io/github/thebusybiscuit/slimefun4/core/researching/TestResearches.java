...
class TestResearches {
    ...
    void testResearchGetters() {
        ...
        SlimefunItem item = TestUtilities.mockSlimefunItem(plugin, "RESEARCH_GETTERS_TEST", CustomItemStack.create(Material.TORCH, "&bResearch Getters Test"));
    ...
    void testPreCanUnlockResearchEvent() throws InterruptedException {
        ...
        SlimefunItem researchItem = TestUtilities.mockSlimefunItem(plugin, "SIMPLE_RESEARCH_TEST", CustomItemStack.create(Material.TORCH, "&bSimple Research Test"));
        research.addItems(researchItem);
        research.register();
