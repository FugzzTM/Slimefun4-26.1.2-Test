...
public class ColoredFireworkStar {
    ...
    public static ItemStack create(Color color, String name, String... lore) {
        ...
        return new ItemStackEditor(Material.FIREWORK_STAR)
                .setDisplayName(name)
                .setLore(lore)
                .addFlags(VersionedItemFlag.HIDE_ADDITIONAL_TOOLTIP == null ? new org.bukkit.inventory.ItemFlag[0] : new org.bukkit.inventory.ItemFlag[] { VersionedItemFlag.HIDE_ADDITIONAL_TOOLTIP })
