...
public final class SlimefunRegistry {
    ...
    public void load(@Nonnull Slimefun plugin, @Nonnull Config cfg) {
        ...
        if (isMockBukkitUnitTest(plugin)) {
            guides.put(SlimefunGuideMode.SURVIVAL_MODE, new NoOpSlimefunGuide(SlimefunGuideMode.SURVIVAL_MODE));
            guides.put(SlimefunGuideMode.CHEAT_MODE, new NoOpSlimefunGuide(SlimefunGuideMode.CHEAT_MODE));
        } else {
    ...
    private static boolean isMockBukkitUnitTest(@Nonnull Slimefun plugin) {
        return plugin.getClass().getClassLoader().getClass().getPackageName().startsWith("be.seeseemelk.mockbukkit");
    }
    ...
    private static final class NoOpSlimefunGuide implements io.github.thebusybiscuit.slimefun4.core.guide.SlimefunGuideImplementation {

        private final SlimefunGuideMode mode;

        private NoOpSlimefunGuide(@Nonnull SlimefunGuideMode mode) {
            this.mode = mode;
        }
        ...
        public @Nonnull ItemStack getItem() {
            return new SlimefunGuideItem(this, mode == SlimefunGuideMode.CHEAT_MODE ? "&cSlimefun Guide &4(Cheat Sheet)" : "&aSlimefun Guide &7(Chest GUI)");
        }
        ...
        @Override
        public void openItemGroup(PlayerProfile profile, io.github.thebusybiscuit.slimefun4.api.items.ItemGroup group, int page) {
        }
