...
class TestProfileResearches {
    ...
    void testSetResearched() throws InterruptedException {
        ...
        SlimefunItem item = TestUtilities.mockSlimefunItem(plugin, "PROFILE_RESEARCH_TEST", CustomItemStack.create(Material.TORCH, "&bProfile Research Test"));
    ...
    void testHasUnlocked() throws InterruptedException {
        ...
        SlimefunItem item = TestUtilities.mockSlimefunItem(plugin, "PROFILE_RESEARCH_TEST_2", CustomItemStack.create(Material.TORCH, "&bProfile Research Test 2"));
        research.addItems(item);
        research.register();
    ...
    void testGetResearches() throws InterruptedException {
        ...
        SlimefunItem item = TestUtilities.mockSlimefunItem(plugin, "PROFILE_RESEARCH_TEST_3", CustomItemStack.create(Material.TORCH, "&bProfile Research Test 3"));
        research.addItems(item);
        research.register();
